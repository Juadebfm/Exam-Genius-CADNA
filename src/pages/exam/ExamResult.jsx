  ...
  useEffect(() => {
    const fetchResult = async () => {
      try {
        ...
        const examResponse = await apiClient.get(
          API_ENDPOINTS.EXAM_WITH_ANSWERS(examId),
        );
        ...
        const resultResponse = await apiClient.get(
          API_ENDPOINTS.RESULT_BY_EXAM(examId),
        );
    ...
    return (
      ...
      >
        ...
        <main className="lg:ml-64 pt-20 px-4 sm:px-6 lg:px-8 py-6">
          <div
            className={`${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-lg p-12 text-center`}
          >
            <div className="text-6xl mb-4">❌</div>
            <h2
              className={`text-xl font-semibold ${darkMode ? "text-white" : "text-gray-900"} mb-2`}
            >
              Result Not Found
            </h2>
            <p
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      <main className="lg:ml-64 pt-20 px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* Main Content */}
        <div
          className={`${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-lg p-6`}
        >
          {/* Exam Overview Section */}
          <div className="mb-8">
            <h2
              className={`text-lg font-semibold ${darkMode ? "text-white" : "text-gray-900"} mb-6`}
            >
              Exam Overview
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <p
                  className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-500"} mb-2`}
                >
                  Total Score
                </p>
                <p
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="w-full">
                <thead>
                  ...
                  >
                    <th
                      className={`text-left py-3 px-4 text-sm font-semibold ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                    >
                      Question
                    </th>
                    <th
                ...
                <tbody>
                  {questionBreakdown.map((q, index) => (
                    ...
                    >
                      <td
                        className={`py-3 px-4 text-sm ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                      >
                        Question {q.number}
                      </td>
                      <td
              ...
              {questionBreakdown.map((q, index) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <p
                        className={`font-semibold ${darkMode ? "text-white" : "text-gray-900"} mb-1`}
                      >
                        Question {q.number}
                      </p>
                      <p
