...
import { apiClient, API_ENDPOINTS } from "../../config/api.js"; // ✅ ADD THIS
...
const WebcamCheck = () => {
  ...
  // ✅ UPDATED: Create exam session before starting
      ...
      <div className="py-4 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-6">
            <FiShield
              className={`w-16 h-16 mx-auto mb-4 ${darkMode ? "text-blue-400" : "text-blue-600"}`}
              strokeWidth={1}
            />
            <h1
              className={`text-3xl font-semibold ${darkMode ? "text-white" : "text-gray-900"} mb-4 text-center`}
            >
              Webcam Check
            </h1>
            <p
              className={`${darkMode ? "text-gray-300" : "text-gray-500"} mb-6 text-center`}
            >
              Please enable your webcam and follow the instructions below to
              proceed with your exam.
            </p>

            <div className="flex items-center space-x-2 mb-6 ">
              <FiCamera
                className={`h-5 w-4 mx-3 ${darkMode ? "text-gray-400" : "text-gray-600"}`}
              />
              <span
          ...
          <div
            className={`w-full h-64 border-2 border-dashed ${darkMode ? "border-gray-600" : "border-gray-300"} rounded-lg flex flex-col items-center justify-center mb-8 overflow-hidden p-6`}
          >
            {cameraEnabled ? (
              <div className="text-center">
                <div
                  className={`w-16 h-16 mx-auto mb-3 rounded-lg ${darkMode ? "bg-gray-700" : "bg-gray-100"} flex items-center justify-center`}
                >
                  <FiCheckCircle className="w-8 h-8 text-green-600" />
                </div>
                <p
                  className={`${darkMode ? "text-gray-500" : "text-gray-400"} text-sm font-medium`}
                >
                  Webcam verified successfully
                </p>
              </div>
            ) : (
              <div className="text-center">
                ...
                <p
                  className={`${darkMode ? "text-gray-400" : "text-gray-500"} text-sm mb-4`}
                >
                  Click below to enable your webcam for verification
                </p>
                <button
          ...
          <div className="mb-8">
            <h2
              className={`text-xl font-bold ${darkMode ? "text-gray-200" : "text-gray-800"} mb-4`}
            >
              Instructions
            </h2>
            <ul
              className={`list-disc pl-6 space-y-3 ${darkMode ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>Ensure your webcam is properly connected and working.</li>
              <li>Position yourself clearly in front of the camera.</li>
              <li>
                Make sure you have adequate lighting for clear visibility.
              </li>
          ...
          <div className="mt-20">
            <p className="flex mb-4  mb-6">
              <FiCamera
                className={`h-5 mx-3 ${darkMode ? "text-gray-400" : "text-gray-500"}`}
              />
              <span
                className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-800"}  mb-6`}
              >
                Webcam Access
              </span>
            </p>
